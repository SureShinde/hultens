...
(function (b) {
    ...
    b.ajaxscroll = function (d) {
        ...
        function u() {
            ...
            if (loader.size() == 0) {
                loader = b("<div class='ajaxscroll_loader' style='width: 100%; padding: 40px;'>" + m.loader + "</div>");
                loader.hide()
            }
            return loader
        }
    ...
    b.ajaxscroll.history = function () {
        ...
        this.getState = function () {
            if (c) {
                ...
                haveState = (window.location.hash.substring(0, 7) == "#/sida/");
                if (haveState) {
                    pageNum = parseInt(window.location.hash.replace("#/sida/", ""));
                    return{page:pageNum}
                }
            }
            return false
