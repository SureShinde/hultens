...
use Crealevant\ProductSlider\Model\ResourceModel\Bestsellers\CollectionFactory as BestsellersCollectionFactory;
use Crealevant\ProductSlider\Model\ResourceModel\Mostviewed\CollectionFactory as MostViewedCollectionFactory;
...
abstract class AbstractWidget extends NewWidget
{
    ...
    protected function getDetailsRendererList()
    {
        return $this->getDetailsRendererListName()
            ...
            : $this->getLayout()->createBlock('Crealevant\ProductSlider\Block\View\Element\CustomRendererList')->setWidgetName($this->getWidgetName());
    }
