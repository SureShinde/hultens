...
namespace Crealevant\ProductSlider\Block\View\Element;
 ...
 * @package Crealevant\ProductSlider\Block\View\Element
 */
    ...
    public function getRenderer($type, $default = null, $rendererTemplate = null)
    {
        ...
        if ($type == Configurable::TYPE_CODE) {
            ...
            $renderer = $this->getLayout()
                ->createBlock('Crealevant\ProductSlider\Block\Product\Renderer\Listing\Configurable')
                ->setWidgetName($this->getWidgetName())
                ->setTemplate('Crealevant_ProductSlider::product/listing/renderer.phtml');
