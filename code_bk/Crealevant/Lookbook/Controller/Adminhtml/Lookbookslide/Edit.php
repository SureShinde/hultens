...
class Edit extends \Crealevant\Lookbook\Controller\Adminhtml\Lookbookslide
{
    /**
     * Core registry
     *
    ...
    public function execute()
    {
        ...
        $this->_initAction()->_addBreadcrumb(
            ...
            $this->_view->getLayout()->createBlock('Crealevant\Lookbook\Block\Adminhtml\EditSlide')
        );
